    ...
    <div class="column bg-white q-mt-xl flex flex-center q-pa-md radius" style="width: 90%">
      ...
      <div class="col">
        <div class="column q-pa-sm text-center">
          ...
          <div class="col" >
            <img :src="cancion.imgCancion" alt="imgCancion" style="width: 50%;border: 5px solid #E89D10" class="radius"/>
          </div>
        </div>
      </div>
      <div class="col" style="width: 100%">
        <div class="row q-pa-sm flex flex-center " style="width: 100%">
          <div class="col q-pa-sm text-center bg-primary radius">
            <div style="width: 100%">
              <p  class="text-black my-fontRubik q-pa-xl text-h3 radius">Letra: </p>
              <div v-for="(text, index) in object.lyrics" :key="index">
                <p class="text-black my-fontRubik q-pa-xl text-h6">{{ text }}</p>
              </div>
            </div>
          </div>
